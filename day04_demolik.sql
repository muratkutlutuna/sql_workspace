...
-- ============================== DELETE ===================================  
    ...
    savepoint abc;-- geri cagirirken rollpoint abc; olarak cagirabilmek icin nurda savepoint kodu ile kaydediyoruz
  rollback to abc;
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/   
      ...
      delete from ogrenciler where isim='mustafa bak';
...
/* -----------------------------------------------------------------------------
 ...
 delete from ogrenciler where isim='nesibe yilmaz' or isim='mustafa bak';
   delete from ogrenciler where isim='nesibe yilmaz' || isim='mustafa bak'; -- calismiyor
   delete FROM ogrenciler WHERE REGEXP_LIKE(isim, 'Nesibe Yilmaz' or 'Mustafa Bak');-- calismadi
