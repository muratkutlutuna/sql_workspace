/*============================== JOIN İSLEMLERİ ===============================
    ...
    2) LEFT JOIN:  Ilk tabloda (Sol) tabloda olan sonuclari gosterir
    3) RIGHT JOIN: Sadece Ikinci (sag)tabloda olan tum sonuclari gosterir
...
order by p.personel_isim, b.bolum_isim ;
