...
-- tekrarli gelmesin istersek union yazariz, tekrarlilarin gelmesi icin de union all yazariz
select isim
from personel
where sirket='honda'
union 
...
from personel_bilgi
where id=123;
    -- isim yazarken araya '-' tire koyuyorsak o isimler kebap case oluyor,
    -- araya'_' alttire koyarsak snake case oluyor
    /* -----------------------------------------------------------------------------
